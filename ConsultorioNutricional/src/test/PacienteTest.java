...
public class PacienteTest {
	...
	public void consultarPacientePorNomeSucesso() {
		...
		esperado.add(new Paciente("Walace", "Rua Qualquer Também", "31988888888", "walace@gmail.com", new Date()));
	...
	public void cadastrarPacienteSucesso() {
		Paciente novoPaciente = new Paciente("Joaquina", "Rua Qualquer Também", "31988888888", "walace@gmail.com", new Date());
	...
	public void cadastrarPacienteFalha() {
		Paciente novoPaciente = new Paciente("Walace", "Rua Qualquer Também", "31988888888", "walace@gmail.com", new Date());
	...
	public void removerPacienteFalha() {
		Paciente novoPaciente = new Paciente("Joao", "Rua Qualquer Também", "31988888888", "walace@gmail.com", new Date());
