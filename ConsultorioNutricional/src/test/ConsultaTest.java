...
public class ConsultaTest {
	...
	public void cadastrarConsultaFalha() {
		Consulta novaConsulta = new Consulta("Pedro", new Date(), "16h", Double.valueOf(80), Double.valueOf(15), "nada consta", "Sem restrição");
	...
	public void verificarExisteConsultaSucesso() {
		Consulta novaConsulta = new Consulta("Welker", new Date(), "16h", Double.valueOf(80), Double.valueOf(15), "nada consta", "Sem restrição");
